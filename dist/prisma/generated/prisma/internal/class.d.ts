 ...
 * `prisma.categorias`: Exposes CRUD operations for the **Categorias** model.
  ...
  */
    ...
    /**
     * `prisma.alerta_stock`: Exposes CRUD operations for the **Alerta_stock** model.
      * Example usage:
      * ```ts
      * // Fetch zero or more Alerta_stocks
      * const alerta_stocks = await prisma.alerta_stock.findMany()
      * ```
      */
    get alerta_stock(): Prisma.Alerta_stockDelegate<ExtArgs, {
        omit: OmitOpts;
    }>;
    /**
     ...
     * `prisma.detalle_Pedidos`: Exposes CRUD operations for the **Detalle_Pedidos** model.
      ...
      * ```
      */
    get detalle_Pedidos(): Prisma.Detalle_PedidosDelegate<ExtArgs, {
        omit: OmitOpts;
    }>;
    /**
