...
export const addToCart = asyncHandler(async (req, res) => {
    ...
    if (newQuantity > product.stock) {
        throw new AppError(`La cantidad solicitada excede el stock disponible. Solo hay ${product.stock} pieza(s).`, 400);
    }
...
export const updateCartItemQuantity = asyncHandler(async (req, res) => {
    ...
    if (quantity > cartItem.producto.stock) {
        throw new AppError(`La cantidad solicitada excede el stock disponible. Solo hay ${cartItem.producto.stock} pieza(s).`, 400);
    }
