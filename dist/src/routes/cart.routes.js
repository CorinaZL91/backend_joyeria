...
import { addToCartSchema, cartItemParamsSchema, updateCartItemQuantityBodySchema, removeCartItemQuerySchema, } from "../validators/cart.schemas.js";
const router = Router();
...
router.delete("/items/:producto_id", validate({
    params: cartItemParamsSchema,
