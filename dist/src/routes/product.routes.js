...
import { z } from "zod";
import { createProduct, deleteProduct, getAdminProducts, getProductById, getProducts, updateProduct, } from "../controller/product.controller.js";
...
router.put("/:id", authenticate, authorizeRole(RolUsuario.administrador), upload.single("imagen"), validate({
    params: productIdParamsSchema,
    body: updateProductSchema,
}), updateProduct);
router.delete("/:id", authenticate, authorizeRole(RolUsuario.administrador), validate({ params: productIdParamsSchema }), deleteProduct);
