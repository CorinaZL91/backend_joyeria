...
// @ts-nocheck 
/*
 * This file exports the `AlertaStock` model and its related types.
 *
...
export type GetAlertaStockAggregateType<T extends AlertaStockAggregateArgs> = {
      [P in keyof T & keyof AggregateAlertaStock]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateAlertaStock[P]>
    : Prisma.GetScalarType<T[P], AggregateAlertaStock[P]>
}
...
type GetAlertaStockGroupByPayload<T extends AlertaStockGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<AlertaStockGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof AlertaStockGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], AlertaStockGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], AlertaStockGroupByOutputType[P]>
      }
    >
  >
...
export type AlertaStockCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<AlertaStockFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface AlertaStockDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['AlertaStock'], meta: { name: 'AlertaStock' } }
  /**
   ...
   * })
  **/
  count<T extends AlertaStockCountArgs>(
    args?: Prisma.Subset<T, AlertaStockCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], AlertaStockCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends AlertaStockGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, AlertaStockGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetAlertaStockGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
